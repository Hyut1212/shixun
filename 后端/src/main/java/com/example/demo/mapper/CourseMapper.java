...
public interface CourseMapper {
    ...
    @Select("<script>" + "select id,course_name,teacher_name,course_type,pay_type,state from course"+ "<where>" + "<if test ='courseName!=null and courseName !=\" \"'>" + " and course_name LIKE '%${courseName}%'" + "</if>"+"<if test ='teacherName!=null and teacherName !=\" \"'>" + " and teacher_name LIKE '%${teacherName}%'" + "</if>"+ "and state = 0"+ "</where>"+"</script>")
